  ...
  <body onload="myLoadHeader()">
    ...
    <main>
      <section class="sekcja1">
        ...
        <center>
          <h2>Można dobrać jeden z dostępnych stworzonych utworów</h2>
          <br>
          
          <select name="file" id="utwor1">
            <option value="wlasne_utwory/chopin_original.mp3">Chopin</option>
            
          </select>
          <select name="file" id="utwor2">
            <option value="wlasne_utwory/chopin.mp3">Chopin Cover</option>
            
          </select>
          <select name="file" id="utwor3">
            <option value="wlasne_utwory/audacity.mp3">Audacity</option>
           
          </select><select name="file" id="utwor4">
            <option value="nothing.mp3">Dowolne</option>
            <?php
              $files = glob("wlasne_utwory/*.{mp3}", GLOB_BRACE);
              foreach($files as $file)
              {
                  echo '<option value="wlasne_utwory/' .basename($file) . '">' . basename($file) . '</option>';
              }
              ?>
          </select>
